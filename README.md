...
```
  git clone https://github.com/aabdulva/devsecops-crash-course-pygoat-demo.git
  ### To Download a specific branch
  git clone -b <branch_name> https://github.com/aabdulva/devsecops-crash-course-pygoat-demo.git
```
